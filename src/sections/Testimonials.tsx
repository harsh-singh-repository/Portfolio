      ...
      <div className="py-16 lg:py-24">
        <div className="container">
          <SectionHeader
            ...
            description="Don't take my words for it. See what my client have to say about my work."
                  ...
                  {testimonials.map((testimonial) => (
                    ...
                    >
                      ...
                      <div className="flex gap-4 items-center">
                        <div className="size-14 bg-gray-700 inline-flex rounded-full items-center justify-start flex-shrink-0">
                          <Image
